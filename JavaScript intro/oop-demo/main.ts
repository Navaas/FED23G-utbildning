...
const rectArea = rect.calculateArea(); // rect är samma som this
const letterArea = letter.calculateArea(); // letter är samma som this

// -------------------------consol log cirklar och rektanglar ------------------------ //

console.log("letter", letter.calculateArea(), letter.calculatePerimeter());

console.log("head", head.calculateArea());
console.log("head", head.calculatePerimeter());

console.log("plate", plate.calculateArea());
console.log("plate", plate.calculatePerimeter());
